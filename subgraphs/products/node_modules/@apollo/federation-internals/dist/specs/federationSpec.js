...
const cacheTagSpec_1 = require("./cacheTagSpec");
...
(function (FederationDirectiveName) {
    ...
    FederationDirectiveName["CACHE_TAG"] = "cacheTag";
...
class FederationSpecDefinition extends coreSpec_1.FeatureDefinition {
    constructor(version) {
        ...
        if (version.gte(new coreSpec_1.FeatureVersion(2, 12))) {
            this.registerDirective((0, directiveAndTypeSpecification_1.createDirectiveSpecification)({
                name: FederationDirectiveName.CACHE_TAG,
                locations: [graphql_1.DirectiveLocation.OBJECT, graphql_1.DirectiveLocation.FIELD_DEFINITION],
                repeatable: true,
                args: [{ name: 'format', type: (schema) => new definitions_1.NonNullType(schema.stringType()) }],
                composes: true,
                supergraphSpecification: (fedVersion) => cacheTagSpec_1.CACHE_TAG_VERSIONS.getMinimumRequiredVersion(fedVersion),
...
exports.FEDERATION_VERSIONS = new coreSpec_1.FeatureDefinitions(exports.federationIdentity)
    ...
    .add(new FederationSpecDefinition(new coreSpec_1.FeatureVersion(2, 11)))
    .add(new FederationSpecDefinition(new coreSpec_1.FeatureVersion(2, 12)))
    .add(new FederationSpecDefinition(new coreSpec_1.FeatureVersion(2, 13)))
    .add(new FederationSpecDefinition(new coreSpec_1.FeatureVersion(2, 14)));
